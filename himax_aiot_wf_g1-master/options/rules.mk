...
.SECONDEXPANSION:
$(APPL_FULL_NAME).elf : $(ALL_GENERATED_DIRS_TMPFILES) $(CORE_ARG_FILES) $(APPL_LINK_FILE) $(APPL_OBJS) $(EXTRA_OBJS) $(INTEGRATE_OBJS) $(HWACCAUTOTEST_OBJS) $(SCENARIO_APP_OBJS) $(EVENTHANDLER_OBJS) $(EMBARC_LIB) $(BOARD_OPEN_LIB_SOCKET) $(CV_LIB) $(AZ_SDK_LIB) $(NETXDUO_LIB) $(BSS_LIB) $(MLI_LIB) $(SECURE_LIB) $(AUDIO_ALGO_LIB) $(ALANGO_ALGO_LIB) $(GNU_DEP_LIB) $$(COMMON_COMPILE_PREREQUISITES)
	$(TRACE_LINK)
	$(Q)$(LD) $(LINK_OPT) $(APPL_OBJS) $(EXTRA_OBJS) $(INTEGRATE_OBJS) $(HWACCAUTOTEST_OBJS) $(SCENARIO_APP_OBJS) $(EVENTHANDLER_OBJS) $(LD_START_GROUPLIB) $(EMBARC_LIB) $(BOARD_OPEN_LIB_SOCKET) $(CV_LIB) $(AZ_SDK_LIB) $(NETXDUO_LIB) $(BSS_LIB) $(MLI_LIB) $(SECURE_LIB) $(AUDIO_ALGO_LIB) $(ALANGO_ALGO_LIB) $(GNU_DEP_LIB) $(APPL_LIBS) $(LD_SYSTEMLIBS) $(LD_END_GROUPLIB) -o $@
